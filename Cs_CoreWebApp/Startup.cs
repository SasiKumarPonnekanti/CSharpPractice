...
namespace Cs_CoreWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //by reading key from appsettings.json
            ...
            services.AddDbContext<sample1Context>(options => {
                ...
                //Register the custom services those cantain business logic 
                // Service Interface and class Implementing the interface
