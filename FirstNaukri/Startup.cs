...
namespace FirstNaukri
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IService<Employer, int>, EmployerInfoService>();
            services.AddScoped<IService<JobProfile, int>, JobProfileService>();
